...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Benny.Harvey15',
      password: 'IveK76aAgCDjcv2',
      email: 'Maxime99@yahoo.com',
      name: 'Rose Homenick III',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Integrated',
          address1: 'contingency',
          address2: 'groupware',
          landmark: 'Inverse',
          city: 'system',
          isDefault: false,
          state: 'XSS',
          addressType: 'Architect',
          fullName: 'District',
          mobile: 668,
          addressNo: 704
        }
      ...
      userType: 675,
      mobileNo: '(060) 596-6774',
      resetPasswordLink: {},
      loginRetryLimit: 586,
      loginReactiveTime: '2023-02-24T07:16:43.193Z',
      id: '637b88db26fa89dd795e3503'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jayson7',
        'password':'bIMwmaw2j3Xw8Tm',
        'email':'Susie.Heathcote@yahoo.com',
        'name':'Darla Champlin',
        'shippingAddress':[{
          '_id':false,
          'pincode':'fuchsia',
          'address1':'Practical',
          'address2':'Coordinator',
          'landmark':'invoice',
          'city':'Personal',
          'isDefault':true,
          'state':'Plastic',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Susie.Heathcote@yahoo.com', });
