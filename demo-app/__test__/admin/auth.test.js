...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Monte58',
      password: 'Kyzif4GaniNuxGo',
      email: 'Wiley.Gutmann62@gmail.com',
      name: 'June Heathcote',
      shippingAddress: [
        {
          _id: false,
          pincode: 'synergy',
          address1: 'sensor',
          address2: 'Object-based',
          landmark: 'synthesizing',
          city: 'up',
          isDefault: true,
          state: 'Account',
          addressType: 'Metal',
      ...
      userType: 309,
      mobileNo: '(326) 716-9906',
      resetPasswordLink: {},
      loginRetryLimit: 656,
      loginReactiveTime: '2023-11-09T09:33:17.802Z',
      id: '637b88db26fa89dd795e342b'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Gretchen.Tromp',
        'password':'vbKFecuPiPfkQMN',
        'email':'Clement.Berge47@yahoo.com',
        'name':'Karl Champlin',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Plastic',
          'address1':'definition',
          'address2':'interactive',
          'landmark':'Guatemala',
          'city':'Fork',
          'isDefault':false,
          'state':'Handcrafted',
          'addressType':'synthesize',
          'fullName':'networks',
          'mobile':633,
          'addressNo':34
        }],
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Clement.Berge47@yahoo.com', });
