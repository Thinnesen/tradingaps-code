...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Lon39',
      password: 'EboZN3oe3lIKjWT',
      email: 'Frances_Nitzsche@hotmail.com',
      name: 'Vera Stanton',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 446,
      mobileNo: '(151) 030-5324',
      resetPasswordLink: {},
      loginRetryLimit: 753,
      loginReactiveTime: '2023-03-28T11:40:52.743Z',
      id: '637b88db26fa89dd795e3497'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Vivien_Steuber',
        'password':'bVeeF_fQp4m0kxe',
        'email':'Jacky.Boehm92@hotmail.com',
        'name':'Lawrence Anderson DVM',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Monitored',
          'address1':'Plastic',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Jacky.Boehm92@hotmail.com', });
